    ...
    <div className="fr-page">
      ...
      <section className="fr-hero">
        <div className="fr-hero-inner">
          ...
          <h2>Turn to us for upholstery cleaning services in Las Cruces and El Paso, TX</h2>
          <p>
            ...
            cleaning services in Las Cruces and El Paso, TX. We'll remove stains and discoloring from your
      ...
      <section className="fr-stains">
        <div className="fr-stains-inner">
          ...
          <div className="fr-stains-image">
            <img
              src={require('../gray-sectional.jpg')}
